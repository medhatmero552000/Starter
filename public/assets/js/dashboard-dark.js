...
var options3 = {
  chart: { type: "pie", height: 120, sparkline: { enabled: true } },
  series: [35, 30, 20, 15],
  labels: ["خدمات", "تطبيقات", "أجهزة", "أخرى"],
  colors: ["#00B8D9", "#7367F0", "#FF9F43", "#EA5455"],
  legend: { show: false }
};
    new ApexCharts(document.querySelector("#ordersChart2"), options3).render();
  }
  // Orders Chart 4 (تم تصحيح الخطأ هنا)
  if($('#ordersChart4').length) {
var options1 = {
  chart: { type: "polarArea", height: 120, sparkline: { enabled: true } },
  series: [14, 23, 21, 17, 15],
  labels: ["تطبيقات", "مبيعات", "أجهزة", "خدمات", "أخرى"],
  stroke: { width: 1 },
  colors: ["#7367F0", "#28C76F", "#EA5455", "#FF9F43", "#00B8D9"],
  legend: { show: false },
  fill: { opacity: 0.8 }
};

    new ApexCharts(document.querySelector("#ordersChart4"), options1).render();
  }
